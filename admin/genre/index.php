                ...
                <form method="post" id="form">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="" name="name" class="form-control" id=""
                                    placeholder="Genre Name" required="" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <button style="margin-bottom: 10px !important;" name="register" type="submit" class="btn btn-primary mt-3">Upload Genre</button>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="default-ordering" class="table table-hover dataTable no-footer"
                                            ...
                                            <tbody>
                                                ...
                                                $conn = $db->conn;
                                                    $songs = new Music();
                                                    $all_genre = $songs->getAllGenre();
                                                    $count = 0;
   
                                                  foreach( $all_genre as $genre){ 
                                                    $count++;
                                                    $date = date("D-M-Y H:i:s", strtotime($genre['created_at']));
;
                                                   ?>
                                                      <tr>
                                                        <td><?= $count ?></td>
                                                         ...
                                                         <td>
                                                            <a class="del-btn" data-delete="<?= htmlspecialchars($genre['id']) ?>" style="background-color: green; padding: 6px 10px; color: white;" href="">Delete</a>
                                                            <!-- <a href="">Delete</a> -->
                                                         </td>
                                                      </tr>
                                                  <?php }
                ...
                <script>
                    ...
                    form.addEventListener("submit", async (e) => {
                        ...
                        try {
                            ...
                            const response = await fetch("../api/genre/addgenre.php", {
                                method: 'POST',
                                body: formData
                    ...
                    document.querySelectorAll(".del-btn").forEach(btn =>{
                        btn.addEventListener("click", async (e) =>{
                           ...
                           try {
                            ...
                            const response = await fetch("../api/genre/deletegenre.php?delete_id=" + encodeURIComponent(del_id))
