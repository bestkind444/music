...
if (!isset($_GET['edit_music']) || !is_numeric($_GET['edit_music'])) {
...
$conn = $db->conn;
$songs = new Music();
$artists_song = $conn->query("SELECT * FROM songs WHERE id = $id");
$all = $artists_song->fetch_assoc();
            ...
            <div class="layout-px-spacing">
                ...
                <form method="post" id="form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="<?= htmlspecialchars($all['title']) ?>" name="title" class="form-control" id=""
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="duration" class="form-control" id=""
                                    placeholder="Title Name" value="<?= htmlspecialchars($all['duration']) ?>" required="" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="album">Created At</label>
                                <input type="text" value="<?= htmlspecialchars($all['created_at']) ?>" name="created_at" class="form-control" id=""
                                    placeholder="Title Name" required="" autocomplete="off">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input readonly type="text" value="" name="duration" class="form-control"
                                    placeholder="duration song" required="" autocomplete="off">
                            </div>
