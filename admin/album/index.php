                                        ...
                                        <table id="default-ordering" class="table table-hover dataTable no-footer"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="default-ordering" rowspan="1" colspan="1"
                                                        aria-label="NAME: activate to sort column ascending"
                                                        style="width: 168.25px;">GENRE</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="default-ordering" rowspan="1" colspan="1"
                                                        aria-label="NAME: activate to sort column ascending"
                                                        style="width: 168.25px;">ALBUM</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($all_album as $album) {
                                                    $count++;
                                                    $date = date("D-M-Y H:i:s", strtotime($album['created_at']));
                                                ?>
                                                    <tr>
                                                        <td><?= $count ?></td>
                                                        ...
                                                        <td>
                                                            <a class="del-btn" data-delete="<?= htmlspecialchars($album['id']) ?>" style="background-color: green; padding: 6px 10px; color: white;" href="">Delete</a>
                                                            <!-- <a href="">Delete</a> -->
                                                        </td>
                                                    </tr>
                                                <?php }
                ...
                <script>
                    ...
                    form.addEventListener("submit", async (e) => {
                        ...
                        try {
                            ...
                            const response = await fetch("../api/album/addalbum.php", {
                                method: 'POST',
                                body: formData
