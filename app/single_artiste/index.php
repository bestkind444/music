          ...
          <div class="col-md-12">
            ...
            <div class="wm-event wm-event-list">
              <ul>
                ...
                $id = $_GET['single'];
                $music = new Music();
                $data = $music->getSingleArtiseSongById($id, $page);
                $songs = $data['songs'];
                    ...
                    <li class="col-md-12">
                      ...
                      <div class="wm-event-text">
                        ...
                        <div class="wm-event-link">
                          <a href="../download.php?id=<?= $song['id'] ?>">Download</a>
            ...
            <div class="wm-pagination-wrap">
              <ul class="wm-pagination">
                <?php if ($currentPage > 1): ?>
                  <li><a href="?single=<?= $id ?>&page=<?= $currentPage - 1 ?>"><i class="flaticon-arrows"></i></a></li>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                  <li class="<?= $i == $currentPage ? 'active' : '' ?>">
                    <a href="?single=<?= $id ?>&page=<?= $i ?>"><?= $i ?></a>
                  </li>
                <?php endfor; ?>
